...
- `images/friction-measuring-the-learning-struggle-fig-NN.svg` — static SVG (→ PNG for EPUB)
- `d3/friction-measuring-the-learning-struggle-fig-NN.html` — interactive D3 HTML
